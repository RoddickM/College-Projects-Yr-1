...
def popular_destination():
    ...
    def menu_pop():
        ...
        if choice_main == 1:
            print("PROGRAMMER TO CREATE RELEVANT CHART HERE")
...
def commission_earned():
    ...
    print("Please choose an option from the menu below", 10 * "~")
    print(Bcolors.CYAN + "[" + Bcolors.END, "1", Bcolors.CYAN + "]" + Bcolors.END + "JetWay")
    print(Bcolors.CYAN + "[" + Bcolors.END, "2", Bcolors.CYAN + "]" + Bcolors.END + "Barry Air")
    print(Bcolors.CYAN + "[" + Bcolors.END, "3", Bcolors.CYAN + "]" + Bcolors.END + "Super Jet")
    print(Bcolors.CYAN + "[" + Bcolors.END, "4", Bcolors.CYAN + "]" + Bcolors.END + "Yorkshire")
    print(Bcolors.CYAN + "[" + Bcolors.END, "5", Bcolors.CYAN + "]" + Bcolors.END + "Lift")
    print(Bcolors.CYAN + "[" + Bcolors.END, "6", Bcolors.CYAN + "]" + Bcolors.END + "Compare all the commissions earned by all the airlines")
    print(Bcolors.CYAN + "[" + Bcolors.END, "7", Bcolors.CYAN + "]" + Bcolors.END + "Exit ")
...
def main_menu():
    ...
    print(Bcolors.CYAN + "[" + Bcolors.END, "1", Bcolors.CYAN + "]" + Bcolors.END + "Choose a destination and compare prices of flights")
    print(Bcolors.CYAN + "[" + Bcolors.END, "2", Bcolors.CYAN + "]" + Bcolors.END + "Display graphs for most popular destinations")
    print(Bcolors.CYAN + "[" + Bcolors.END, "3", Bcolors.CYAN + "]" + Bcolors.END + "Display commission earned from sales from different airlines")
    ...
    if choice_main == 1:
        Task4a_flight_prices.comparison()
    elif choice_main == 2:
        popular_destination()
    elif choice_main == 3:
        commission_earned()
...
def main():
    while True:
        ...
        if user_name == 'Bob' and password == 'rainbow123':
            time.sleep(1)
